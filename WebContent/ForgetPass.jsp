...
<div class="description comp-content with-sidebar _panel" >
  ...
  <form action="ForgetPass" method="post" id="form1">

<table><tr><td>请输入您的用户名（邮箱）：</td><td><input type="text" name="username" /></td></tr><tr><td><input type="submit" value="发送密码"  /></td><td></td></tr></table>
...
<script type="text/javascript">
   ...
   <script id="talent" language="javascript"  >
	...
	new tt.RV().set(new RegExp("^[a-zA-Z0-9]{0,10}$"),
    "只能输入a-z,A-Z,0-9,且长度为1-10").add("passwd"); 
