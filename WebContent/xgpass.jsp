...
<head>
    ...
    <meta name="robots" content="index, follow" />
		...
		<script src="js/talent-validate-all.js" language="javascript"></script><script src="js/demo.js" language="javascript">
...
<p id="p1" style="text-indent:2em ">   <form action="xgpass" method="post" id="form1">

<table><tr><td>用户名：</td><td><input type="text" name="username" /></td></tr><tr><td>原密码：</td><td>
<input type="password" name="passwd" /></td></tr>
<tr><td>新密码：</td><td>
<input type="password" name="newpasswd1" /></td></tr>
<tr><td>再次输入新密码：</td><td>
<input type="password" name="newpasswd2" /></td></tr>
<tr><td><input type="button" value="修改密码 " onclick="checkandsubmit()" /></td><td></td></tr></table>
...
<script type="text/javascript">
   ...
   <script id="talent" language="javascript"  >
	new tt.LV().set(0, 30).add("username");  
	new  tt.LV().set(0, 10).add("passwd");  
	new tt.LV().set(0, 30).add("newpasswd1");  
	new  tt.LV().set(0, 10).add("newpasswd2"); 
	
	tt.vf.req.add("username", "passwd","newpasswd1","newpasswd2"); 
	tt.vf.email.add("username"); 
	new tt.RV().set(new RegExp("^[a-zA-Z0-9]$"),
    "只能输入a-z,A-Z,0-9").add("passwd"); 
