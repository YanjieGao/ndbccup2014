...
<p id="p1" >  组委会主任：     </p>
                  <p style="text-indent:2em ">周立柱（清华大学）</p>
                   <p style="text-indent:2em ">张阔（搜狗公司）

</p>
<p id="p1" >  组委会委员：     </p>
                    <p style="text-indent:2em ">王建勇（清华大学）</p>
                    <p style="text-indent:2em ">高军（北京大学）

</p>
                    <p style="text-indent:2em ">陈跃国（中国人民大学）

</p>
                   
                    <p style="text-indent:2em ">张坤（搜狗公司）

</p>
                   <p style="text-indent:2em ">康琪（搜狗公司）
